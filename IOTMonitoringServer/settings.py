...
ALLOWED_HOSTS = ["localhost", "ec2-3-94-116-250.compute-1.amazonaws.com"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "ec2-23-22-192-28.compute-1.amazonaws.com",  # Dirección IP de la base de datos
...
MQTT_HOST = "ec2-3-91-253-115.compute-1.amazonaws.com"
