...
ALLOWED_HOSTS = ["localhost", "ec2-54-147-211-192.compute-1.amazonaws.com"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "ec2-3-89-255-186.compute-1.amazonaws.com",  # Dirección IP de la base de datos
...
MQTT_HOST = "ec2-54-91-0-130.compute-1.amazonaws.com"
