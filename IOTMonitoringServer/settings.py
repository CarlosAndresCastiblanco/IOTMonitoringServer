...
ALLOWED_HOSTS = ["localhost", "ec2-3-80-81-135.compute-1.amazonaws.com"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "ec2-54-226-140-4.compute-1.amazonaws.com",  # Dirección IP de la base de datos
...
MQTT_HOST = "ec2-54-84-255-25.compute-1.amazonaws.com"
