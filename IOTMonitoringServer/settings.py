...
ALLOWED_HOSTS = ["localhost", "ec2-44-205-16-52.compute-1.amazonaws.com"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "ec2-98-80-191-161.compute-1.amazonaws.com",  # Dirección IP de la base de datos
...
MQTT_HOST = "ec2-3-235-109-46.compute-1.amazonaws.com"
