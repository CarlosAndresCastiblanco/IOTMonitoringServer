...
ALLOWED_HOSTS = ["localhost", "ec2-54-160-197-129.compute-1.amazonaws.com"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "ec2-54-234-143-79.compute-1.amazonaws.com",  # Dirección IP de la base de datos
...
MQTT_HOST = "ec2-54-83-96-112.compute-1.amazonaws.com"
